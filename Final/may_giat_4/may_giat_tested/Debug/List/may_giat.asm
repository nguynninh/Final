...
_0x0:
	.DB  0x44,0x61,0x6E,0x67,0x20,0x67,0x69,0x61
	.DB  0x74,0x0,0x54,0x6F,0x63,0x20,0x64,0x6F
	.DB  0x3A,0x20,0x25,0x64,0x0,0x4D,0x61,0x79
	.DB  0x20,0x67,0x69,0x61,0x74,0x0
_0x2080003:
	.DB  0x80,0xC0
_0x2120060:
	.DB  0x1
...
; 0000 006C         sprintf(speedText, "Toc do: %d", curSpeed);
	LDI  R30,LOW(_speedText)
	LDI  R31,HIGH(_speedText)
	ST   -Y,R31
	ST   -Y,R30
	__POINTW1FN _0x0,10
	ST   -Y,R31
...
; 0000 006D         glcd_outtextxy(10, 40, speedText);
	...
	LDI  R30,LOW(40)
	ST   -Y,R30
	LDI  R26,LOW(_speedText)
	LDI  R27,HIGH(_speedText)
	CALL _glcd_outtextxy
; 0000 006E 
