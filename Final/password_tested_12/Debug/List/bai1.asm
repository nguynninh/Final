...
_0x0:
	...
	.DB  0x3F,0x0,0x4E,0x4F,0x3F,0x0,0x50,0x41
	.DB  0x53,0x53,0x45,0x44,0x0,0x4E,0x45,0x57
	.DB  0x20,0x50,0x41,0x53,0x53,0x3F,0x0,0x53
	.DB  0x41,0x56,0x45,0x44,0x0
_0x2080060:
	.DB  0x1
_0x2080000:
...
;	reader -> Y+6
	CALL SUBOPT_0x3
	LDI  R26,LOW(_my_eeprom)
	LDI  R27,HIGH(_my_eeprom)
	CALL __EEPROMRDW
	STD  Y+6,R30
	STD  Y+6+1,R31
