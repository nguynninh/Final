...
_0x3:
	...
	.DB  0x8
_0x0:
	.DB  0x4E,0x65,0x78,0x74,0x3A,0x0,0x4E,0x65
	.DB  0x78,0x74,0x3A,0x20,0x0,0x43,0x75,0x72
	.DB  0x72,0x65,0x6E,0x74,0x3A,0x0,0x43,0x75
	.DB  0x72,0x72,0x65,0x6E,0x74,0x3A,0x20,0x0
_0x2060003:
	.DB  0x80,0xC0
_0x2080060:
	.DB  0x1
...
; 0000 00AD             currentLevel++;
	LDI  R26,LOW(_currentLevel)
	LDI  R27,HIGH(_currentLevel)
	CALL SUBOPT_0x6
...
; 0000 011F     order[currentLevel] = false;
	LDS  R26,_currentLevel
	LDS  R27,_currentLevel+1
	SUBI R26,LOW(-_order)
	SBCI R27,HIGH(-_order)
	LDI  R30,LOW(0)
	ST   X,R30
; 0000 0120     dung_DC();
	RCALL _dung_DC
...
SUBOPT_0x5:
	LDS  R30,_currentLevel
	LDS  R31,_currentLevel+1
	RET
